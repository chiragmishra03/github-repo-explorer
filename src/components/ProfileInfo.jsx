  ...
  return (
    <div className="lg:w-1/3 w-full flex flex-col gap-2 md:sticky md:top-10">
      <div className="bg-glass rounded-lg p-4">
        ...
        {/* Member Since Date */}
        <div className="my-2">
          <p className="text-green-600 font-bold text-sm">Member since</p>
        ...
        {userProfile?.email && (
          <div className="my-2">
            <p className="text-green-600 font-bold text-sm">Email address</p>
        ...
        {userProfile?.name && (
          <div className="my-2">
            <p className="text-green-600 font-bold text-sm">Full name</p>
        ...
        {/* Username */}
        <div className="my-2">
          <p className="text-green-600 font-bold text-sm">Username</p>
